<div class="w-[90%] h-[48px] mx-auto my-0 mt-[20px] flex justify-between items-center">
    <div class="flex gap-[5px]">
        <p class="text-[18px] font-semibold">Customer Order</p>
    ...
    <div class="flex gap-x-[10px] h-full">
        ...
        <input type="text" class="w-[331px] h-full py-[9px] px-[40px] bg-[#FCFCFD] placeholder-[#C3C3C3] text-[14px] rounded-[10px]" placeholder="Search">
        <i class="fa-solid fa-magnifying-glass text-[20px] text-[#C3C3C3] absolute top-[50%] translate-y-[-50%] left-[5%]"></i>
    </div>
