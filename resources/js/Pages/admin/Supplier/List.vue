<template>
    <AppLayout>
        <div class="p-6 bg-gray-50 min-h-screen">
            <div
                class="p-4 bg-white mb-6 flex justify-between items-center rounded-xl shadow-sm"
            >
                            ...
                            >
                                ...
                                >
                                    ...
                                    <td class="px-6 py-4 relative">
                                        ...
                                        >
                                            <ul
                                                class="py-2 text-sm font-medium text-gray-800"
                                            >
                                                <li>
                                                    <Waiting
                                                        color="bg-white"
                                ...
                                <tr
                                    v-if="expandedRows[supplier.id]"
                                    class="bg-indigo-100"
                                >
                                    <td colspan="7" class="px-6 py-4">
                                        <div
                                            class="ml-8 my-4 bg-white rounded-xl shadow-sm border border-indigo-200"
                                        >
                                            <div
                                                class="flex items-center p-5 border-b border-indigo-100"
                                            >
                                                <i
                                                    class="fas fa-receipt mr-3 text-indigo-500 text-lg"
                                                ></i>
                                                <h6
                                                    class="font-bold text-indigo-700 text-xl"
                                                >
                                                    Lịch sử công nợ
                                                </h6>
                                            </div>
                                            <div class="overflow-x-auto">
                                                ...
                                                >
                                                    <thead
                                                        class="text-xs text-indigo-700 bg-indigo-50"
                                                    >
                                                        <tr>
                                                            <th
                                                    ...
                                                    <tbody>
                                                        <template
                                                            v-for="purchase_order in supplier.purchase_orders || {
                                                                good_receipts: false,
                                                            }"
                                                        >
                                                            <tr
                                                            ...
                                                            >
                                                                <td
                                                                    class="px-6 py-3 font-medium text-indigo-600"
                                                                    @click="
                                                                        ShowDetail(
                                                                            receipt.id
                                                                        )
                                                                ...
                                                                <td
                                                                    class="px-6 py-3 max-w-xs truncate"
                                                                    @click="
                                                                        ShowDetail(
                                                                            receipt.id
                                                                        )
                                                                ...
                                                                <td
                                                                    class="px-4 py-3 text-sm text-gray-500 absolute"
                                                                >
                                                                    <button
                                                                        @click="
                                                                            toggleActionPopup(
                                                                    ...
                                                                    >
                                                                        ...
                                                                        >
                                                                            ...
                                                                            >
                                                                                <button
                                                                                    v-can="
                                                                                        'admin.supplier_transaction.update_credit_due_date'
                                                                                    "
                                                                                    @click="
                                                                                ...
                                                                                <button
                                                                                    v-can="
                                                                                        'admin.supplier_transaction.update_paid_amount'
                                                                                    "
                                                                                    @click="
                                                                                        openPayment(
                                                                                            receipt
                                                        ...
                                                        >
                                                            ...
                                                            >
                                                                ...
                                                                >
                                                                    <i
                                                                        class="fas fa-inbox text-4xl text-indigo-200 mb-3"
                                                                    ></i>
                                                                    <span
                                                                        class="text-base"
                                                                        >Không
            ...
            <ModalCreditDueDate
                v-if="isOpenCredit"
                :transactionSupplierEdit="transactionSupplierEdit"
