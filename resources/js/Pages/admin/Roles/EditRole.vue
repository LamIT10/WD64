                        ...
                        <form @submit.prevent="hanldeSubmitForm" class="space-y-6">
                                ...
                                <div class="space-y-6 mt-4">
                                    <div v-for="permission in permissions" :key="permission.id"
                                        ...
                                        <div class="flex justify-between items-center mb-3">
                                            ...
                                            <button type="button" @click="toggleAllPermissions(permission.permission)"
                                        ...
                                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 pl-6">
                                            <div v-for="value in permission.permission" :key="value.id"
                                                ...
                                                <label class="flex items-center cursor-pointer w-full">
                                                    ...
                                                    <span class="ml-3 text-sm text-gray-700 flex-1">{{ value.description
                                                    }}</span>
                                                </label>
                                            </div>
                                        </div>
                            ...
                            <div class="flex justify-end space-x-3 pt-4 border-t border-gray-200">
                                <Waiting route-name="admin.role.index"
                                    color="bg-indigo-400 hover:bg-indigo-600 text-white">
                                    Hủy bỏ
                                </Waiting>
