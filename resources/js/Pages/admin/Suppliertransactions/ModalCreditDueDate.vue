            ...
            >
                ...
                <transition name="modal">
                    ...
                    >
                        ...
                        <div
                            class="p-6 bg-gradient-to-r from-indigo-500 to-indigo-600 rounded-t-xl"
                        >
                            <h3
                                class="text-xl font-semibold text-white uppercase tracking-wider"
                            >
                        ...
                        <div class="pt-6 ps-6 pe-6 space-y-4">
                            ...
                            <input
                                ...
                                type="text"
                                v-model="form.sub_credit_due_date"
                                v-date-picker
                            />
                        </div>
                        ...
                        <div
                            class="px-6 py-4 bg-gray-50 rounded-b-xl flex justify-between space-x-3"
                        >
                            <button
...
const form = useForm({
    sub_credit_due_date: formatDateForDisplay(
        transactionSupplierEdit.value.supplier_transaction.credit_due_date
    ),
    credit_due_date: "",
    note: "",
});
...
const handleSubmit = () => {
    ...
    form.patch(
        route("admin.supplier-transaction.update", {
