        ...
        <div class="fixed inset-0 bg-opacity-30 backdrop-blur-sm flex items-center justify-center p-4 z-50">
            ...
            <div class="bg-white rounded-lg shadow-xl max-w-md w-full">
                ...
                <div class="border-b p-4 bg-gray-50 rounded-t-lg">
                    <h3 class="text-lg font-semibold uppercase">Cập nhật hạn công nợ</h3>
                </div>

                <!-- Nội dung modal -->
                <div class="p-4">
                    <input class="w-full p-2 auto-format-date border-black border rounded-l rounded-r" type="date" v-model="form.credit_due_date" >
                </div>

                <!-- Footer modal -->
                <div class="border-t p-4 flex justify-end bg-gray-50 rounded-b-lg">
                    <button class="px-4 py-2 me-2 bg-gray-500 text-white rounded hover:bg-gray-600" @click="handleCloseModal()">
                        Huỷ bỏ
                    </button>
                    <button class="px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-600" @click="handlSubmit()">
                        Đồng ý
                    </button>
                </div>
