        ...
        <div class="fixed inset-0 bg-opacity-30 backdrop-blur-sm flex items-center justify-center p-4 z-50">
            ...
            <div class="bg-white rounded-lg shadow-xl max-w-md w-full">
                ...
                <div class="border-b p-4 bg-gray-50 rounded-t-lg">
                    <h3 class="text-lg font-semibold uppercase">Cập nhật thanh toán công nợ</h3>
                </div>

                <!-- Nội dung modal -->
                <div class="p-4">
                    <input class="w-full p-2 auto-format-date border-black border rounded-l rounded-r" type="text" v-model="form.payment" >
                </div>
