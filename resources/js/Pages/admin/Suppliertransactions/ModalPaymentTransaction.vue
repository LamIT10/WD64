            ...
            >
                ...
                <transition name="modal">
                    ...
                    >
                        ...
                        <div
                            class="p-5 bg-gradient-to-r from-indigo-500 to-indigo-600 rounded-t-xl"
                        >
                            <h3
                                class="text-xl font-semibold text-white uppercase tracking-wide flex items-center"
                            >
                                <svg
                        ...
                        <!-- Footer modal -->
                        <div
                            class="px-6 py-4 bg-gray-50 rounded-b-xl flex justify-between items-center"
                        >
                            <button
