<template>
    <div>
        ...
        <transition name="fade">
            <div class="fixed inset-0 bg-black/30 backdrop-blur-sm flex items-center justify-center p-4 z-50 transition-opacity duration-200">
                <!-- Modal với hiệu ứng xuất hiện mượt mà -->
                <transition name="modal">
                    <div class="bg-white rounded-xl shadow-2xl max-w-md w-full transform transition-all duration-200 ease-out">
                        ...
                        <div class="p-6 space-y-4">
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Số tiền thanh toán (VND)</label>
                        ...
                        <div class="px-6 py-4 bg-gray-50 rounded-b-xl flex justify-between items-center">
                            ...
                            <button 
                                ...
                                :disabled="!form.payment || form.payment <= 0"
                                @click="handleSubmit()">
                                Xác nhận thanh toán
                            </button>
                        </div>
