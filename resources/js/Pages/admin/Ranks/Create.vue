                ...
                <div class="w-full p-6">
                    <form @submit.prevent="confirmSubmit" class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
                            ...
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Tổng chi tiêu tối thiểu
                                    *</label>
                            ...
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Phần trăm chiết khấu
                                    *</label>
...
const submit = () => {
    console.log('Dữ liệu form trước khi chuẩn hóa:', form.data());
    form.transform((data) => ({
        ...data,
