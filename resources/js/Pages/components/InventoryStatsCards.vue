<template>
  <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
    ...
    <a href="/admin/inventory/statistics" class="block transition duration-200 hover:shadow-md hover:-translate-y-0.5">
      <div class="bg-white p-6 rounded-xl border border-gray-100 flex items-start space-x-4 shadow-sm">
        <!-- Icon -->
        ...
        <!-- Text content -->
        <div>
          <p class="text-sm text-gray-500 font-medium">Thống kê tồn kho</p>
          <p class="text-xl font-semibold text-gray-800 mt-1">Đến trang thống kê</p>
          <p class="text-xs text-gray-400 mt-2">Cập nhật lần cuối: 2 giờ trước</p>
        </div>
      </div>
    </a>
    ...
    <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100 flex items-start">
      <div class="p-3 bg-green-50 rounded-lg mr-4">
        ...
        <img :src="avatar" class="w-12 h-12 rounded-lg object-cover" />
  ...
  <!-- <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100 flex items-start">
      <div class="p-1 bg-green-50 rounded-lg mr-4">
      </div>
      <div>
        <p class="text-sm font-medium text-gray-500">Active Customers</p>
        <p class="text-2xl font-bold text-gray-800 mt-1">27</p>
